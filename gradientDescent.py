...
#best weights found via genetic evolution
...
#hill climbing optimization with true cost function
...
#hill climbing optimization with neural net
...
#return output from true cost function
def calcFunc(x):
    valueOne = (6 * x - 2) ** 2
